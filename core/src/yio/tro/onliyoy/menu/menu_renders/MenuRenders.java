...
public class MenuRenders {
    ...
    public static RenderChooseColorElement renderChooseColorElement = new RenderChooseColorElement();
    ...
    public static RenderQmsElement renderQmsElement = new RenderQmsElement();
    public static RenderInGameEntityListItem renderInGameEntityListItem = new RenderInGameEntityListItem();
    public static RenderCgmElement renderCgmElement = new RenderCgmElement();
    ...
    public static RenderTutorialListItem renderTutorialListItem = new RenderTutorialListItem();
    ...
    public static RenderCoinsElpViewElement renderCoinsElpViewElement = new RenderCoinsElpViewElement();
    public static RenderRveCoinsElpItem renderRveCoinsElpItem = new RenderRveCoinsElpItem();
    public static RenderRatingListItem renderRatingListItem = new RenderRatingListItem();
    public static RenderDelayedActionElement renderDelayedActionElement = new RenderDelayedActionElement();
    public static RenderSmileysKeyboardElement renderSmileysKeyboardElement = new RenderSmileysKeyboardElement();
    public static RenderRveSmileysItem renderRveSmileysItem = new RenderRveSmileysItem();
    public static RenderFishNameViewElement renderFishNameViewElement = new RenderFishNameViewElement();
    ...
    public static RenderAvatars renderAvatars = new RenderAvatars();
    public static RenderNumberedSeparatorItem renderNumberedSeparatorItem = new RenderNumberedSeparatorItem();
    public static RenderFishProductItem renderFishProductItem = new RenderFishProductItem();
    public static RenderEconomyListItem renderEconomyListItem = new RenderEconomyListItem();
    ...
    public static RenderRulesPickerElement renderRulesPickerElement = new RenderRulesPickerElement();
    public static RenderPlotViewElement renderPlotViewElement = new RenderPlotViewElement();
    public static RenderRenamingListItem renderRenamingListItem = new RenderRenamingListItem();
    public static RenderOfflineUlevItem renderOfflineUlevItem = new RenderOfflineUlevItem();
