...
public enum NmType {
    ...
    request_available_rejoin_list,

    rejoin_list,

    request_rejoin_match,
    ...
    request_restore_levels,

    request_admin_matches_report,
    ...
    request_to_check_renaming,

    cant_find_renaming,

    request_admin_preparation_report,

    request_self_kick,

    do_report_user,

    request_admin_user_reports,
    ...
    request_admin_report_elp,

    get_dossier_by_rating,
    ...
    billing_on_purchases_updated,

    billing_notify_consume,

    notify_fish_received,
    ...
    debug_request_current_turn,

    rename_user_level,

    mass_check_renamings,

    on_user_level_completed,
