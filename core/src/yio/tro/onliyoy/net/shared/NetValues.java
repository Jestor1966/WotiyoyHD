...
public class NetValues {
    ...
    public static final NetLocationType LOCATION_TYPE = NetLocationType.local;
    public static final int PROTOCOL = 0 + 10 * 220405;
    ...
    public static final long PHRASE_DELAY = 30 * 1000;
