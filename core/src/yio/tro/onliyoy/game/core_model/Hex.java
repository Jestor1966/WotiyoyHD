...
public class Hex extends AbstractPmObjectYio implements Encodeable {
    ...
    public void updateFarmDiversityIndex() {
        farmDiversityIndex = (999999 + 101 * coordinate1 * coordinate2 + 7 * coordinate2) % 3;
        //System.out.println(farmDiversityIndex+" "+coordinate1+" "+coordinate2);
    }
    ...
    public boolean hasSiege() {
        return piece == PieceType.town || piece == PieceType.fort;
    }

    public boolean hasMountain(){
        return piece == PieceType.mountain;
    }
